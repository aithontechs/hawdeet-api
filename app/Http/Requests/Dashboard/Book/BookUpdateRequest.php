...
class BookUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'release_year' => ['sometimes' , 'integer' , 'digits:4' , 'min:1900' , 'max:' . Carbon::now()->addYear()->year],
            ...
            'price_usd' => [$isDigital ? 'sometimes' : 'nullable', 'numeric', 'min:0'],
            'compare_price_usd' => ['nullable', 'numeric', 'gt:price_usd'],
            'physical_price_usd' => [$isPhysical ? 'sometimes' : 'nullable', 'numeric', 'min:0'],
            'physical_compare_price_usd' => ['nullable', 'numeric', 'gt:physical_price_usd'],
            'physical_hard_cover_price_usd' => ['nullable', 'numeric    ', 'min:0'],
